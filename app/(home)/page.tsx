...
export default async function Home() {
  return (
    <>
    <PageTransition>
      <section className=" relative z-0  -mt-20">
        <MotionParallax speed={0.3} type={1}>
          <div className="flex items-center box-border h-screen bg-cover relative bg-center z-0">
            ...
            <div className="absolute box-border background-hero bottom-0 z-0 inset-0 backdrop-brightness-80 h-screen  bg-eko-900 bg-opacity-50"></div>
                  ...
                  <MotionShow
                    ...
                    <div className="max-w-3xl -mt-52  mx-auto">
                      <h1 className="mb-5  lg:text-7xl md:text-6xl px-2  text-5xl  text-white font-bold">
                        <small>
                          {" "}
                          Nous vous <span>interviewons</span> et consignons
                          votre mémoire <br />
                          sur des supports{" "}
