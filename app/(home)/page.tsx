...
export default function Home() {
        ...
        <div className="content">
          ...
          <div className="written-biography-option">
            ...
            <p>
              ...
              tout comme les mythes et légendes ont survécu grâce à leur
              transcription.
            </p>
   ...
   */}
      <section id="digital-box" className="digital-box-section">
        <div className="content">
          <h2>Votre coffret numérique : Souvenirs préservés, accès facilité</h2>
          <p>
            Toutes vos créations - podcasts & livres - soigneusement conservées
            dans votre espace privé sécurisé.
          </p>
      ...
      <section className="perfect-gift-section">
        <div className="content">
          <h2>Un cadeau parfait, pour soi ou pour un proche</h2>
          <p>
            Marquez les esprits avec un présent personnalisé : immortalisez les
            histoires qui vous tiennent à cœur dans un podcast unique et une
      ...
      <section className="memories-section">
        <div className="content">
          ...
          <p>
            La transmission de nos récits est un pont entre les générations, un
            moyen d&apos;apprendre, de partager et de se souvenir.
          </p>
          {/*
      ...
      <section className="timeless-memories-section">
        <div className="content">
          <h2>
          ...
          <p>
            Que vous soyez dans la fleur de l&apos;âge ou que vous ayez accumulé
            une sagesse plus mûre, chaque histoire a sa valeur. Des premières
