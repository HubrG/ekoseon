    ...
    <section>
      <div className="content max-w-3xl">
        ...
        <p>
          ...
          services incluent l&apos;organisation d&apos;entretiens en ligne, leur
          montage en podcast, leur gravure sur CD et la transcription en livres
          reliés. Ekoseon vend également des micro-cravates pour améliorer
          l&apos;enregistrement audio des entretiens, réalisés via
          l&apos;application Zencastr.
        </p>

        <h2>3. Processus de commande</h2>
        <p>
          La sélection et le paiement des services se font sur le site
          d&apos;Ekoseon. Les clients choisissent le nombre d&apos;heures
          d&apos;entretien et les options désirées, avec un paiement sécurisé
          par Stripe. Un échelonnement du paiement est proposé pour des montants
          supérieurs à 300€. Suite à la commande, un pré-entretien est organisé
          pour préciser le projet et planifier les séances
          d&apos;enregistrement.
        </p>
        ...
        <p>
          ...
          entretien, et la biographie est livrée en quatre semaines à partir du
          dernier enregistrement. Les micros sont expédiés immédiatement après
        ...
        <p>
          ...
          rétractation, les frais de Stripe sont déduits. Pour les biographies,
          le coût de l&apos;heure d&apos;entretien incluant la biographie est
          retenu avec une réduction dégressive allant jusqu&apos;à 30%.
        </p>
        ...
        <p>
          Ekoseon peut réviser ces CGV à tout moment. Les clients seront soumis
          aux politiques et CGV en vigueur au moment de leur commande, sauf
          changement requis par la loi ou autorité gouvernementale.
        </p>

        <h2>11. Loi applicable et résolution des litiges</h2>
        <p>
          Ces CGV sont soumises au droit français. En cas de litige, les parties
          chercheront une résolution amiable avant toute procédure judiciaire. À
          défaut d&apos;accord, le litige sera porté devant les juridictions
          compétentes.
        </p>
      </div>
    </section>
