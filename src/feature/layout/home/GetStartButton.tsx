...
export const GetStartButton = () => {
  ...
  return (
	<Button
	  ...
	  size="lg"
	  variant="link"
	  className="mx-auto flex flex-row w-auto  hover:no-underline gap-x-5 items-center mt-10 md:text-3xl text-2xl font-display py-8 justify-center   gap-y-1 hover:bg-opacity-60 border border-fuchsia-100  hover:border-fuchsia-800 hover:border-solid hover:bg-fuchsia-900  text-white hover:text-fuchsia-100  bg-opacity-80">
	  C&apos;est-à-dire
